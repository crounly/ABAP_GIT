*&---------------------------------------------------------------------*
*& Report  ZABAPGIT_TEST_PROGRAM_A
*&
*&---------------------------------------------------------------------*
*& DRB 05.02.2017 PRograma Ejemplo ABAP
*& Este programa es solo de prueba para poder probar la extraccion
*& de codigo con el cliente de repositorios GIT para ABAP
*&---------------------------------------------------------------------*
